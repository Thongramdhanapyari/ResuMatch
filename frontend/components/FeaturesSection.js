    ...
    <section id="features" className="pt-0 pb-6 md:pb-10">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 pt-8 md:gap-6 md:pt-10">
        {features.map((feature) => (
          ...
          >
            <div className="relative h-[110px] md:h-[150px] w-full overflow-hidden">
              <img
                src={feature.image}
                alt={feature.title}
            ...
            <div className="px-4 py-4 md:px-5 md:py-5 text-center">
              <h3 className="text-[13px] md:text-[16px] font-semibold text-[#1E293B] transition duration-300 group-hover:text-black">
                {feature.title}
              </h3>

              <p className="mt-2 text-[11px] md:text-[13px] leading-4 md:leading-5 text-[#475569] opacity-0 transition duration-500 group-hover:opacity-100 group-hover:text-slate-800">
                {feature.description}
              </p>
            </div>
